    ...
    elementos: [
      {
        ...
        tipo: 'switch',
        codigo: 'SW-01',
        nombre: 'Switch Principal Rack PB',
        pos_x: 24,
        pos_y: 35,
        estado: 'activo',
        propiedades: {
          marca: 'Ubiquiti UniFi',
          modelo: 'USW-24-POE Gen2',
          ip: '192.168.1.2',
          ubicacion: 'Rack Principal PB',
          cantidadPuertos: 24,
          observaciones: 'Switch Gigabit PoE administrable',
        },
      },
      {
        id: 'elem-boca-01',
        ...
        propiedades: {
          piso: '2°',
          ubicacion: 'Oficina Admin - Escritorio 1',
          tipoCable: 'Cat 6 UTP Furukawa',
          switchId: 'elem-sw-01',
          puertoNumero: '09',
          observaciones: 'Patchcord azul certificado',
        },
      },
      {
        id: 'elem-boca-02',
...
export const infraestructuraService = {
  ...
  async getSummary(): Promise<ResumenInfraestructura> {
    ...
    return {
      ...
      planosRedes,
      planosCamaras,
      dispositivosRed: switches + bocas + aps,
      camaras,
      dvrs,
    };
  },
